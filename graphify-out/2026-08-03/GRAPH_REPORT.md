...
## Corpus Check
- 63 files · ~129,662 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 615 nodes · 1343 edges · 24 communities (21 shown, 3 thin omitted)
...
- `MainActivity` --implements--> `ShizukuStateListener`  [EXTRACTED]
  android/app/src/main/java/com/gamebooster/app/ui/layout/MainActivity.java → android/app/src/main/java/com/gamebooster/app/shizuku/ShizukuManager.java
...
Cohesion: 0.09
Nodes (16): AppExecutors, Handler, Context, ShizukuManager, ShizukuStateListener, Bundle, Button, LayoutInflater (+8 more)
...
Cohesion: 0.08
Nodes (16): GameBoosterJsInterface, Context, Context, PermissionChannel, ShizukuChannel, Context, ShizukuExecutor, ShizukuUserServiceConnector (+8 more)
