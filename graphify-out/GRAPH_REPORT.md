...
## Corpus Check
- 67 files · ~131,231 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 661 nodes · 1435 edges · 35 communities (28 shown, 7 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `67b154c7`
...
4. `FloatingOverlayService` - 20 edges
...
Cohesion: 0.18
Nodes (9): CpuGovernorChannel, Context, PerformanceChannel, Profile, BALANCED, EXTREME_PERFORMANCE, PERFORMANCE, Context (+1 more)
...
Cohesion: 0.23
Nodes (4): HzFpsChannel, GameLibraryChannel, Context, CommandExecutor

### Community 7 - "ShizukuManager"
Cohesion: 0.05
Nodes (26): AppExecutors, Handler, Context, PermissionChannel, ShizukuChannel, Context, ShizukuExecutor, Context (+18 more)

### Community 8 - "FloatingOverlayService"
Cohesion: 0.08
Nodes (21): AutoGameMonitorService, Context, Handler, IBinder, Intent, Notification, Nullable, Override (+13 more)
...
Cohesion: 0.14
Nodes (8): GameBoosterJsInterface, Context, GameConfigPatcher, PatchResult, GameProfileAutoConfigurator, Context, OnAutoConfigListener, JavascriptInterface
...
### Community 33 - "WebDashboardFragment.java"
Cohesion: 0.30
Nodes (9): Bundle, LayoutInflater, Nullable, Override, View, ViewGroup, WebDashboardFragment, SuppressLint (+1 more)

### Community 34 - ".getPrefs"
Cohesion: 0.50
Nodes (3): Context, SharedPreferences, ManualSettingsPreferences
...
- **Why does `TweakItem` connect `TweakItem` to `ShizukuManager`?**
