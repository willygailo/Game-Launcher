...
JNIEXPORT jboolean JNICALL Java_com_gamebooster_app_config_NativeConfigInjector_nativeInjectMlbbDamage10000AttackSpeedMax
  (JNIEnv *env, jclass, jstring jPath) {
    ...
    std::vector<std::pair<std::string, std::string>> keys = {
        ...
        {"MagicPenMax", "10000"}, {"ArmorIgnorePercent", "100.0"}, {"ArmorPiercingMultiplier", "10000.0"},
        {"CritRateBoost", "100"}, {"CritDamageMultiplier", "10.0"},
        {"AttackSpeedBoost", "10000"}, {"AttackSpeedCap", "10.0"}, {"AttackSpeedUnlock", "1"},
        {"AttackSpeedMax", "1"}, {"BasicAttackRate", "10"}, {"AutoAttackInterval", "0"},
        {"BasicAttackInterval", "0"}, {"AttackIntervalMin", "0"},
        {"AttackAnimSpeed", "10.0"}, {"AttackWindup", "0"}, {"AttackBackswing", "0"},
        {"AttackAnimBlend", "0"}, {"InstantBasicAttack", "1"}, {"HeroAnimationCancel", "1"},
        {"BeatrixReloadSpeed", "10.0"}, {"FastReload", "1"}, {"GunSwapZeroDelay", "1"},
        {"WeaponReloadDuration", "0"}, {"ProjectileSpeedBoost", "10.0"},
        {"SkillCastDelay", "0"}, {"InstantSkillCast", "1"},
        {"HitRegSyncRate", "1000"}, {"HitRegistrationRate", "1000"}, {"InstantHitReg", "1"},
        {"SpellVampBoost", "100"}, {"LifestealBoost", "100"},
        {"EnergyRegenBoost", "100"}, {"ManaRegenBoost", "100"},
