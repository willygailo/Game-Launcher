...
public class SettingsManager {
    ...
    public void backupOriginalValues() {
        ...
        editor.putString("backup_" + KEY_TOUCH_SLOP_REDUCTION, getSystemSetting("system", KEY_TOUCH_SLOP_REDUCTION));
    ...
    public boolean applyProfile(InputProfile profile) {
        ...
        ShizukuExecutor.executeShizukuCommand("settings put system " + KEY_TOUCH_SLOP_REDUCTION + " " + profile.getTouchSlopReduction());
    ...
    public boolean restoreOriginalValues() {
        ...
        restoreSetting("system", KEY_TOUCH_SLOP_REDUCTION);
    ...
    private void restoreProp(String key) {
        ...
        if (original != null && !original.isEmpty()) {
            ...
            ShizukuExecutor.executeShizukuCommand("setprop " + key + " \"\"");
        }
    }
    ...
    private void restoreSetting(String table, String key) {
        ...
        if (original != null && !original.isEmpty()) {
            ...
            ShizukuExecutor.executeShizukuCommand("settings delete " + table + " " + key);
        }
    }
    ...
    public void setDeviceTuned(boolean tuned) {
        prefs.edit().putBoolean(KEY_IS_TUNED, tuned).apply();
    }
}
