...
public class GenshinConfigPatcher {
    ...
    public static boolean patchCompetitive(String packageName, int targetFps) {
        ...
        Log.i(TAG, "Genshin competitive 165FPS force-write: " + written + " paths @ 165fps for " + packageName);
        return written > 0;
    }
    ...
    public static void applyAimAssistConfig(String packageName) {
        ...
        for (String path : paths) {
            String cmd =
                ...
                "grep -qF '\"damage_multiplier\"' " + path + " || echo '\"damage_multiplier\": 2.0,' >> " + path + "; " +
                "sed -i 's/\"damage_multiplier\":.*/\"damage_multiplier\": 2.0,/' " + path + "; " +
                ...
                "grep -qF '\"crit_rate_boost\"' " + path + " || echo '\"crit_rate_boost\": 1.0,' >> " + path + "; " +
                "sed -i 's/\"crit_rate_boost\":.*/\"crit_rate_boost\": 1.0,/' " + path + "; " +
        ...
        Log.i(TAG, "Genshin 1000Hz Gyro, Damage & No-Recoil applied for " + packageName);
    }
