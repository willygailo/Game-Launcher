package com.gamebooster.app.feature.spoofer.ui;
...
public class ProfilesFragment extends Fragment {
    ...
    private void showGameConfigPickerDialog() {
        ...
        AppExecutors.getInstance().executeScan(() -> {
            List<com.gamebooster.app.feature.games.GameAppInfo> installedGames = com.gamebooster.app.feature.games.GameManagerRepository.getInstalledGames(getContext());
            ...
            AppExecutors.getInstance().postToMainThread(() -> {
                ...
                new androidx.appcompat.app.AlertDialog.Builder(getContext())
                        ...
                        .setItems(gameNames, (dialog, which) -> {
                            com.gamebooster.app.feature.games.GameAppInfo selectedGame = installedGames.get(which);
    ...
    private void showFpsSelectionDialog(com.gamebooster.app.feature.games.GameAppInfo game) {
        ...
        new androidx.appcompat.app.AlertDialog.Builder(getContext())
                ...
                .setItems(fpsOptions, (dialog, which) -> {
                    ...
                    com.gamebooster.app.feature.performance.device.DevicePerformanceCapabilities caps =
                            com.gamebooster.app.feature.performance.device.DevicePerformanceCapabilities.detect(getContext());
                    ...
                    GameProfilePreferences.Profile selectedProfile =
                            requestedFps <= 90
                    ...
                    GameProfilePreferences.setProfile(
                            getContext(), game.getPackageName(), selectedProfile);

                    AppExecutors.getInstance().executeCommand(() -> {
                        GameConfigPatcher.PatchResult result =
                                GameConfigPatcher.applyGameFpsPatch(
