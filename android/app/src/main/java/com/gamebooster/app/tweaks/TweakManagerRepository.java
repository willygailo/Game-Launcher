...
public class TweakManagerRepository {
    ...
    static {
        ...
        TWEAKS.add(new TweakItem(
                ...
                "setprop debug.graphics.game_default_frame_rate.disabled 0; setprop ro.vendor.dfps.enable 0; setprop vendor.display.enable_default_fps_switch 0; setprop persist.vendor.power.dfps.level 0; setprop persist.vendor.display.vrr.disable 1; setprop debug.sf.fps_limit 0; setprop persist.sys.NV_FPSLIMIT 0; settings put system match_content_frame_rate 0; settings put secure match_content_frame_rate_preference 0",
                TweakCategory.TOUCH_DISPLAY,
                true
        ));
        ...
        TWEAKS.add(new TweakItem(
                ...
                "cmd game mode standard global 2>/dev/null; cmd game reset global 2>/dev/null; setprop debug.graphics.game_default_frame_rate.disabled 0; settings put system match_content_frame_rate 0",
                TweakCategory.SHIZUKU_SYSTEM,
                true
        ));
    }
