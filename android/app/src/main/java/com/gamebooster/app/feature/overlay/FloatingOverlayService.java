...
public class FloatingOverlayService extends Service {
    ...
    private boolean setupFloatingView() {
        ...
        isDndActive = com.gamebooster.app.feature.games.space.GameSpaceDndManager.isDndActive(getApplicationContext());
            ...
            btnExtreme.setOnClickListener(v -> {
                com.gamebooster.app.core.AppExecutors.getInstance().executeCommand(() -> {
                    ...
                    com.gamebooster.app.feature.performance.booster.MaxHzForceChannel.ForceResult forceRes =
                            com.gamebooster.app.feature.performance.booster.MaxHzForceChannel.forceApply(getApplicationContext(), targetHz, null);
                    com.gamebooster.app.feature.performance.booster.PerformanceChannel.ProfileResult result =
                            com.gamebooster.app.feature.performance.booster.PerformanceChannel.applyProfileWithResult(
                                    getApplicationContext(),
                                    com.gamebooster.app.feature.performance.booster.PerformanceChannel.Profile.EXTREME_PERFORMANCE);
                    com.gamebooster.app.core.AppExecutors.getInstance().postToMainThread(() -> {
                        android.widget.Toast.makeText(getApplicationContext(),
                                "🚀 " + forceRes.message,
                                android.widget.Toast.LENGTH_LONG).show();
        ...
        if (btnDnd != null) {
            btnDnd.setOnClickListener(v -> {
                ...
                com.gamebooster.app.core.AppExecutors.getInstance().executeCommand(() -> {
                    boolean applied = com.gamebooster.app.feature.games.space.GameSpaceDndManager
        ...
        if (btnBypass != null) {
            btnBypass.setOnClickListener(v -> {
                com.gamebooster.app.core.AppExecutors.getInstance().executeCommand(() -> {
                    com.gamebooster.app.feature.bypass_charging.BypassChargingManager manager =
                            com.gamebooster.app.feature.bypass_charging.BypassChargingManager.getInstance();
        ...
        if (btnTouch != null) {
            btnTouch.setOnClickListener(v -> {
                com.gamebooster.app.core.AppExecutors.getInstance().executeCommand(() -> {
                    com.gamebooster.app.feature.gameprofiles.patcher.TouchUltraFastNoDelayPatcher.applyTouchNoDelay(null);
                    com.gamebooster.app.core.AppExecutors.getInstance().postToMainThread(() -> {
                        android.widget.Toast.makeText(getApplicationContext(),
    ...
    private void updateMetricsText() {
        ...
        if (com.gamebooster.app.platform.shizuku.ShizukuExecutor.hasShizukuPermission()) {
            try {
                String sfFpsRes = com.gamebooster.app.platform.shizuku.ShizukuExecutor.executeShizukuCommand("cmd SurfaceFlinger get_fps");
        ...
        float socTemp = com.gamebooster.app.feature.performance.thermal.ThermalMonitorService.readSocTemperatureSysfs();
        float displayTemp = socTemp > 0 ? socTemp : m.batteryTempC;
        int pingMs = com.gamebooster.app.feature.performance.booster.NetworkOptimizer.measureNetworkPingMs();
