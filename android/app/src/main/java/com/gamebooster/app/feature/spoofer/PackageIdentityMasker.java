...
public class PackageIdentityMasker {
    ...
    static {
        ...
        registerAlias("com.mobile.legends", "pkg_alias_mlbb");
        ...
        registerAlias("com.dts.freefireth", "pkg_alias_freefire");
