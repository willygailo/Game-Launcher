package com.gamebooster.app.feature.gameprofiles.repository;
...
import com.gamebooster.app.feature.gameprofiles.model.CompetitiveCfgProfile;
...
public class CfgProfileManager {
    ...
    private static void applyShizukuHzForce(Context context, int hz) {
        ...
        com.gamebooster.app.feature.performance.display.DisplayOverrideController.Result result =
                com.gamebooster.app.feature.performance.display.DisplayOverrideController.applyDisplayRate(context, hz, null);
