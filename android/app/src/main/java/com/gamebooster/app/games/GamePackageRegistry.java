...
public class GamePackageRegistry {
    ...
    static {
        ...
        KNOWN_GAMES.put("com.dts.freefireth", new GameInfoSpec("Garena Free Fire", "Battle Royale", 165));
        KNOWN_GAMES.put("com.dts.freefiremax", new GameInfoSpec("Free Fire MAX", "Battle Royale", 165));

        // League of Legends: Wild Rift & Regional Variants
        KNOWN_GAMES.put("com.riotgames.league.wildrift", new GameInfoSpec("League of Legends: Wild Rift", "MOBA", 165));
        KNOWN_GAMES.put("com.riotgames.league.wildrifttw", new GameInfoSpec("Wild Rift (TW)", "MOBA", 165));
        KNOWN_GAMES.put("com.riotgames.league.wildriftvn", new GameInfoSpec("Wild Rift (VNG)", "MOBA", 165));

        // Honor of Kings (HOK) / Arena of Valor (AoV)
        KNOWN_GAMES.put("com.levelinfinite.sgameGlobal", new GameInfoSpec("Honor of Kings (Global)", "MOBA", 165));
        KNOWN_GAMES.put("com.levelinfinite.sgameGlobal.gpkg", new GameInfoSpec("Honor of Kings (Global GP)", "MOBA", 165));
        KNOWN_GAMES.put("com.tencent.tmgp.sgame", new GameInfoSpec("Honor of Kings (CN)", "MOBA", 165));
        KNOWN_GAMES.put("com.garena.game.kgtw", new GameInfoSpec("Arena of Valor (TW)", "MOBA", 165));
        KNOWN_GAMES.put("com.garena.game.kgvn", new GameInfoSpec("Arena of Valor (VNG)", "MOBA", 165));
        KNOWN_GAMES.put("com.garena.game.kgid", new GameInfoSpec("Arena of Valor (ID)", "MOBA", 165));

        // Genshin Impact & HoYoverse Titles
        KNOWN_GAMES.put("com.miHoYo.GenshinImpact", new GameInfoSpec("Genshin Impact (CN)", "Action RPG", 165));
        KNOWN_GAMES.put("com.cognosphere.GenshinImpact", new GameInfoSpec("Genshin Impact (Global)", "Action RPG", 165));
        KNOWN_GAMES.put("com.HoYoverse.hkrpgoversea", new GameInfoSpec("Honkai: Star Rail", "RPG", 165));
        KNOWN_GAMES.put("com.HoYoverse.nap", new GameInfoSpec("Zenless Zone Zero", "Action RPG", 165));
        KNOWN_GAMES.put("com.miHoYo.bh3oversea", new GameInfoSpec("Honkai Impact 3rd", "Action RPG", 165));
        ...
        KNOWN_GAMES.put("com.netease.bloodstrike", new GameInfoSpec("Blood Strike", "FPS", 165));
        KNOWN_GAMES.put("com.miracle.farlight84", new GameInfoSpec("Farlight 84", "Battle Royale", 165));

        // Sports & Racing
        KNOWN_GAMES.put("jp.konami.pesam", new GameInfoSpec("eFootball 2024 / PES", "Sports", 165));
        KNOWN_GAMES.put("com.ea.gp.fifamobile", new GameInfoSpec("EA SPORTS FC Mobile", "Sports", 165));
        KNOWN_GAMES.put("com.garena.game.fdtw", new GameInfoSpec("Speed Drifters (Garena)", "Racing", 165));
        KNOWN_GAMES.put("com.gameloft.anmp.android.glofta9hm", new GameInfoSpec("Asphalt 9: Legends", "Racing", 165));
        KNOWN_GAMES.put("com.h20.carxstreet", new GameInfoSpec("CarX Street", "Racing", 165));

        // Supercell Hits
        KNOWN_GAMES.put("com.supercell.brawlstars", new GameInfoSpec("Brawl Stars", "Action", 165));
        KNOWN_GAMES.put("com.supercell.clashroyale", new GameInfoSpec("Clash Royale", "Strategy", 165));
        KNOWN_GAMES.put("com.supercell.clashofclans", new GameInfoSpec("Clash of Clans", "Strategy", 165));
        KNOWN_GAMES.put("com.supercell.squad", new GameInfoSpec("Squad Busters", "Action", 165));
    }
