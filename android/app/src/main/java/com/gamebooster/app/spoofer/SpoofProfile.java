...
public class SpoofProfile {
    ...
    public String[] generateUe4DeviceProfileKeys(int targetFps) {
        ...
        return new String[] {
            ...
            // ── PUBGM 4.6 Engine & Version Whitelist CVars ──
            ...
            "+CVars=r.Vsync=0",
            // ── 4.6 Vulkan, Rendering, and Async Pipeline ──
            "+CVars=r.MobileHDR=1",
    ...
    public String generateUe4DeviceProfile(int targetFps) {
        StringBuilder sb = new StringBuilder();
        String[] keys = generateUe4DeviceProfileKeys(targetFps);
