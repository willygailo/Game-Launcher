        ...
        AppExecutors.getInstance().executeCommand(() -> {
            try {
                ...
                if (appContext != null) {
                    ...
                    if (com.gamebooster.app.config.ManualSettingsPreferences.isWebViewBoostEnabled(appContext)) {
                        com.gamebooster.app.booster.WebViewBoosterChannel.applyWebViewPerformanceBoost(appContext);
                    }
                }
