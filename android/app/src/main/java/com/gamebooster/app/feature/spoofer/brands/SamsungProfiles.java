...
public class SamsungProfiles {
    ...
    public static List<SpoofProfile> getProfiles() {
        ...
        // Galaxy S26 Ultra — Snapdragon 8 Elite Gen 5 for Galaxy, Adreno 840, 24GB LPDDR5X, 165Hz
        list.add(new SpoofProfile(
            ...
            35, "Adreno (TM) 840", "adreno", "196610", 24576, 165
        ));

        // Galaxy S25 Ultra — Snapdragon 8 Elite for Galaxy, Adreno 830, 16GB RAM, 165Hz Extreme
        list.add(new SpoofProfile(
            "samsung_s25_ultra",
            "Galaxy S25 Ultra (165Hz, Snapdragon 8 Elite, Adreno 830, 16GB RAM)",
            "Samsung",
            ...
            34, "Adreno (TM) 830", "adreno", "196610", 16384, 165
        ));

        // Galaxy S24 Ultra — Snapdragon 8 Gen 3 for Galaxy, Adreno 750, 12GB RAM, 165Hz Extreme
        list.add(new SpoofProfile(
            "samsung_s24_ultra",
            "Galaxy S24 Ultra (165Hz, Snapdragon 8 Gen 3, Adreno 750, 12GB RAM)",
            "Samsung",
            ...
            34, "Adreno (TM) 750", "adreno", "196610", 12288, 165
        ));
