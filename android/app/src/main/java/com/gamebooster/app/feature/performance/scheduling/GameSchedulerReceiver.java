package com.gamebooster.app.feature.performance.scheduling;
...
/**
 * GameSchedulerReceiver triggers automatic EXTREME boost profiles during configured peak gaming hours.
 */
public class GameSchedulerReceiver extends BroadcastReceiver {

    private static final String TAG = "GameSchedulerReceiver";
        ...
        AppExecutors.getInstance().executeCommand(() -> {
            if (currentHour >= startHour && currentHour < endHour) {
                ...
                MaxHzForceChannel.forceApply(context,
                        com.gamebooster.app.feature.performance.display.DisplayOverrideController.highestSupportedRate(context), null);
    ...
    public static void scheduleNextAlarm(Context context) {
        ...
        Intent intent = new Intent(context, GameSchedulerReceiver.class);
