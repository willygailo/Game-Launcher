package com.gamebooster.app.feature.settings.ui;
import com.gamebooster.app.feature.settings.preferences.EsportsPreferences;
import com.gamebooster.app.feature.settings.preferences.ManualSettingsPreferences;
import com.gamebooster.app.feature.settings.preferences.PrecisionAimPreferences;
...
import com.gamebooster.app.feature.performance.booster.NetworkOptimizer;
import com.gamebooster.app.feature.performance.tweaks.TweakCategory;
...
import com.gamebooster.app.feature.spoofer.SpoofPreferences;
...
import com.gamebooster.app.feature.overlay.CrosshairOverlayService;
import com.gamebooster.app.feature.overlay.CrosshairOverlayManager;
import com.gamebooster.app.feature.overlay.CrosshairPreferences;
import com.gamebooster.app.feature.overlay.CrosshairPreset;
...
import com.gamebooster.app.feature.spoofer.ui.SpoofProfileAdapter;
import com.gamebooster.app.feature.terminal.ui.TerminalFragment;
import com.gamebooster.app.feature.performance.tweaks.ui.TweaksAdapter;
...
public class SettingsFragment extends Fragment implements ShizukuManager.ShizukuStateListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
                ...
                if (getContext() != null) {
                    if (ShizukuExecutor.hasShizukuPermission()) {
                        ...
                        AppExecutors.getInstance().executeCommand(() -> {
                            int maxHz = 165;
                            try {
                                com.gamebooster.app.feature.performance.device.DevicePerformanceCapabilities caps = com.gamebooster.app.feature.performance.device.DevicePerformanceCapabilities.detect(getContext());
                                if (caps != null && caps.getMaxRefreshRate() > 0) {
                                    maxHz = caps.getMaxRefreshRate();
                                }
                            } catch (Throwable ignored) {}

                            com.gamebooster.app.platform.shizuku.ShizukuForceApplyEngine.ForceApplyResult res =
                                com.gamebooster.app.platform.shizuku.ShizukuForceApplyEngine.forceApplyAll(getContext(), maxHz);
        ...
        if (switchOverlayHud != null && getContext() != null) {
            ...
            boolean isRunning = com.gamebooster.app.feature.overlay.FloatingOverlayService.isOverlayRunning();
            if (savedOverlay && !isRunning && (Build.VERSION.SDK_INT < Build.VERSION_CODES.M || Settings.canDrawOverlays(getContext()))) {
                com.gamebooster.app.feature.overlay.FloatingOverlayService.startOverlay(getContext());
                isRunning = true;
            }
            ...
            switchOverlayHud.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                if (isChecked) {
                    ...
                    com.gamebooster.app.feature.overlay.FloatingOverlayService.stopOverlay(getContext());
        ...
        if (switchGamingDnd != null && getContext() != null) {
            ...
            switchGamingDnd.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                AppExecutors.getInstance().executeCommand(() -> {
                    if (getContext() != null) {
                        com.gamebooster.app.feature.games.space.GameSpaceDndManager.setGamingDndMode(getContext(), isChecked);
                    }
                });
            });
        }
        ...
        if (switchAutoGameBoost != null && getContext() != null) {
            ...
            boolean isRunning = com.gamebooster.app.feature.games.space.AutoGameMonitorService.isRunning();
            if (savedAutoBoost && !isRunning) {
                com.gamebooster.app.feature.games.space.AutoGameMonitorService.start(getContext());
                isRunning = true;
            }
                ...
                AppExecutors.getInstance().executeCommand(() -> {
                    if (getContext() != null) {
                        if (isChecked) {
                            ...
                            com.gamebooster.app.feature.games.space.AutoGameMonitorService.stop(getContext());
                        }
                    }
                });
            });
        ...
        if (switchEsportsAudio != null && getContext() != null) {
            ...
            switchEsportsAudio.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                AppExecutors.getInstance().executeCommand(() -> {
                    if (getContext() != null) {
                        com.gamebooster.app.feature.performance.booster.EsportsAudioEnhancer.setEsportsAudioMode(getContext(), isChecked);
                    }
                });
            });
        }
        ...
        if (btnCleanCaches != null) {
            btnCleanCaches.setOnClickListener(v -> {
                ...
                AppExecutors.getInstance().executeCommand(() -> {
                    com.gamebooster.app.feature.games.space.GameCacheCleaner.CleanResult res =
                            com.gamebooster.app.feature.games.space.GameCacheCleaner.performDeepGameCacheCleanDetailed(getContext());
                    AppExecutors.getInstance().postToMainThread(() -> {
            ...
            switchEnforceHzLock.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                AppExecutors.getInstance().executeCommand(() -> {
                    if (isChecked) {
                        ...
                        com.gamebooster.app.feature.performance.booster.MaxHzForceChannel.lockHz(getContext(), maxHz, null);
                    } else {
                        com.gamebooster.app.feature.performance.booster.MaxHzForceChannel.unlockHz(getContext());
                    }
                    AppExecutors.getInstance().postToMainThread(() -> {
                        if (isAdded() && getContext() != null) {
        ...
        if (switchCpuMode != null) {
            switchCpuMode.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                AppExecutors.getInstance().executeCommand(() -> {
                    com.gamebooster.app.feature.performance.booster.CpuGovernorChannel.setGovernor(isChecked ? "extreme" : "schedutil");
                    AppExecutors.getInstance().postToMainThread(() -> {
                        if (isAdded() && getContext() != null) {
