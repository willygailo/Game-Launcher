package com.gamebooster.app.feature.dashboard.web;
...
import com.gamebooster.app.platform.shizuku.role.RoleManager;

import org.json.JSONObject;

public class GameBoosterJsBridge {

    private final Context context;

    public GameBoosterJsBridge(Context context) {
    ...
    public boolean applyDeviceSpoofProfile(String profileId, String packageName) {
        ...
        com.gamebooster.app.feature.spoofer.SpoofProfile profile =
                com.gamebooster.app.feature.spoofer.DeviceSpooferEngine.getAllProfiles().get(profileId);
        if (profile == null) return false;
        return com.gamebooster.app.feature.spoofer.DeviceSpooferEngine.applyProfile(context, profile, packageName);
    }
    ...
    public String performDeepSearchJson() {
        if (context == null) return "[]";
        try {
            java.util.Set<String> discovered = com.gamebooster.app.feature.games.search.DeepSearchScanner.performDeepSearch(context);
    ...
    public String getAvailableSpoofProfilesJson() {
        try {
            org.json.JSONArray array = new org.json.JSONArray();
            for (com.gamebooster.app.feature.spoofer.SpoofProfile p : com.gamebooster.app.feature.spoofer.DeviceSpooferEngine.getAllProfiles().values()) {
                JSONObject obj = new JSONObject();
                obj.put("id", p.id);
    ...
    public void toggleCrosshairOverlay(boolean enable) {
        if (context == null) return;
        if (enable) {
            com.gamebooster.app.feature.overlay.CrosshairOverlayService.startOverlay(context);
        } else {
            com.gamebooster.app.feature.overlay.CrosshairOverlayService.stopOverlay(context);
        }
    }
    ...
    public String calculateSensitivityJson(int dpi, double screenSize, float gyroMultiplier) {
        try {
            com.gamebooster.app.feature.sensitivity.model.SensitivityModel m =
                    com.gamebooster.app.feature.sensitivity.model.SensitivityCalculator.calculate(dpi, screenSize, gyroMultiplier);
            JSONObject obj = new JSONObject();
    ...
    public String enableBypassCharging() {
        return com.gamebooster.app.feature.bypass_charging.BypassChargingManager.getInstance().enableBypassCharging();
    }

    @JavascriptInterface
    public String disableBypassCharging() {
        return com.gamebooster.app.feature.bypass_charging.BypassChargingManager.getInstance().disableBypassCharging();
    }

    @JavascriptInterface
    public String getBypassStatusJson() {
        try {
            com.gamebooster.app.feature.bypass_charging.BypassChargingInterface strategy =
                    com.gamebooster.app.feature.bypass_charging.BypassChargingManager.getInstance().getCurrentStrategy();
            JSONObject obj = new JSONObject();
    ...
    public String getGameSpoofStrategyJson(String packageName) {
        try {
            com.gamebooster.app.feature.spoofer.games.GameSpooferInterface strategy =
                    com.gamebooster.app.feature.spoofer.games.GameSpooferManager.getInstance().getStrategyForPackage(packageName);
            JSONObject obj = new JSONObject();
            obj.put("strategyName", strategy.getStrategyName());
    ...
    public boolean applyGameSpoofForPackage(String packageName) {
        ...
        return com.gamebooster.app.feature.spoofer.games.GameSpooferManager.getInstance().applySpoofForPackage(context, packageName);
    }

    @JavascriptInterface
    public boolean applySpoofProfileById(String profileId) {
        if (context == null || profileId == null) return false;
        com.gamebooster.app.feature.spoofer.SpoofProfile profile = com.gamebooster.app.feature.spoofer.DeviceSpooferEngine.getProfileById(profileId);
        if (profile == null) return false;
        boolean result = com.gamebooster.app.feature.spoofer.DeviceSpooferEngine.applyProfile(context, profile, null);
        if (result) {
            com.gamebooster.app.feature.spoofer.SpoofPreferences.setSpoofEnabled(context, true);
            com.gamebooster.app.feature.spoofer.SpoofPreferences.setActiveProfileId(context, profileId);
        }
        return result;
    }
    ...
    public boolean setRefreshRateForOem(int hz) {
        if (context == null) return false;
        return com.gamebooster.app.feature.performance.display.DisplayOverrideController
    ...
    public boolean setThermalMitigationForOem(boolean disableThrottling) {
        if (disableThrottling) {
            String res = com.gamebooster.app.feature.performance.thermal.ThermalManager.getInstance().applyThermalOptimization();
            return res != null && !res.startsWith("ERROR");
        } else {
            String res = com.gamebooster.app.feature.performance.thermal.ThermalManager.getInstance().resetThermalSettings();
            return res != null && !res.startsWith("ERROR");
        }
    }
    ...
    public String getAllTweaksJson() {
        try {
            org.json.JSONArray array = new org.json.JSONArray();
            for (com.gamebooster.app.feature.performance.tweaks.TweakItem tweak : com.gamebooster.app.feature.performance.tweaks.TweakManagerRepository.getAllTweaks()) {
    ...
    public boolean applyTweakById(String tweakId) {
        ...
        for (com.gamebooster.app.feature.performance.tweaks.TweakItem tweak : com.gamebooster.app.feature.performance.tweaks.TweakManagerRepository.getAllTweaks()) {
            if (tweak.getId().equalsIgnoreCase(tweakId)) {
                return com.gamebooster.app.feature.performance.tweaks.TweakManagerRepository.applyTweak(context, tweak);
            }
        }
        return false;
    }
    ...
    public boolean revertTweakById(String tweakId) {
        ...
        for (com.gamebooster.app.feature.performance.tweaks.TweakItem tweak : com.gamebooster.app.feature.performance.tweaks.TweakManagerRepository.getAllTweaks()) {
            if (tweak.getId().equalsIgnoreCase(tweakId)) {
                return com.gamebooster.app.feature.performance.tweaks.TweakManagerRepository.revertTweak(context, tweak);
            }
        }
        return false;
    }
    ...
    public String getSessionHistoryJson() {
        if (context == null) return "[]";
        try {
            java.util.List<com.gamebooster.app.feature.games.session.GameSessionLogger.SessionEntry> list =
                    com.gamebooster.app.feature.games.session.GameSessionLogger.getSessionHistory(context);
            org.json.JSONArray array = new org.json.JSONArray();
            for (com.gamebooster.app.feature.games.session.GameSessionLogger.SessionEntry entry : list) {
