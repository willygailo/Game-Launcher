        ...
        AppExecutors.getInstance().executeCommand(() -> {
            ...
            if (isGameActive && !currentPackage.equals(lastActiveGamePackage)) {
                ...
                Log.i(TAG, "GAME LAUNCH DETECTED: " + currentPackage + " — Applying "
                        + profile.label + " @ 165Hz (Zero Fallback)");
                ...
                // 2. Direct Game Config Patching (165 FPS, 2.0x Damage, Zero Recoil, 1000Hz Gyro & Touch)
                com.gamebooster.app.config.GameConfigPatcher.patchGame(currentPackage, 165);
                
                // 3. Multi-layer 165Hz display refresh rate force
                ...
                AppExecutors.getInstance().postToMainThread(() ->
                        android.widget.Toast.makeText(getApplicationContext(), "🎮 " + profile.label
                                + " profile active (165 FPS & 165Hz Locked)", android.widget.Toast.LENGTH_LONG).show());
