...
public class ManualSettingsPreferences {
    ...
    private static final String KEY_WEBVIEW_BOOST = "pref_webview_boost";
    ...
    public static boolean isWebViewBoostEnabled(Context context) {
        if (context == null) return true;
        return getPrefs(context).getBoolean(KEY_WEBVIEW_BOOST, true);
    }
