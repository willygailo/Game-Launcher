...
public class BloodStrikeConfigPatcher {
    ...
    public static boolean patchUltraExtreme144(String packageName) {
        ...
        String[] keys = {
            ...
            "ShadingQuality=2", "TextureQuality=4", "ShadowQuality=0",
            "AntiAliasingQuality=0", "BloomQuality=0", "MaxAnisotropy=1",
            "HDRMode=1", "HDR10Plus=1", "ResolutionScale=100",
