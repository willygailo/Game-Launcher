...
import com.gamebooster.app.feature.performance.tweaks.preferences.TweakPreferences;
...
public class TweakManagerRepository {
    ...
    static {
        ...
        TWEAKS.add(new TweakItem(
                "shizuku_fast_anim",
                "0.5x Ultra Fast Smooth Animations",
                "Accelerates system window transition, scale and animator duration to 0.5x for optimal fast & smooth response",
                "settings put global window_animation_scale 0.5; settings put global transition_animation_scale 0.5; settings put global animator_duration_scale 0.5; settings put system window_animation_scale 0.5; settings put system transition_animation_scale 0.5; settings put system animator_duration_scale 0.5",
    ...
    public static boolean applyTweak(Context context, TweakItem tweak) {
        ...
        if (com.gamebooster.app.platform.shizuku.ShizukuExecutor.hasShizukuPermission()) {
            res = com.gamebooster.app.platform.shizuku.ShizukuExecutor.executeShizukuCommand(tweak.getApplyCommand());
        } else {
    ...
    public static boolean revertTweak(Context context, TweakItem tweak) {
        ...
        String res;
        if (com.gamebooster.app.platform.shizuku.ShizukuExecutor.hasShizukuPermission()) {
            res = com.gamebooster.app.platform.shizuku.ShizukuExecutor.executeShizukuCommand(tweak.getRevertCommand());
        } else {
    ...
    public static void restoreAppliedTweaksAsync(Context context) {
        ...
        AppExecutors.getInstance().executeCommand(() -> {
            ...
            com.gamebooster.app.feature.performance.booster.PerformanceChannel.setGpuRenderMode(isVulkan);

            boolean isPerfCpu = "performance".equalsIgnoreCase(ManualSettingsPreferences.getCpuMode(context));
            com.gamebooster.app.feature.performance.booster.CpuGovernorChannel.setGovernor(isPerfCpu ? "extreme" : "schedutil");
