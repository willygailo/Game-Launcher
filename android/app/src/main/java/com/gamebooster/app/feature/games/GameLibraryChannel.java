...
public class GameLibraryChannel {
    ...
    public static boolean launchGame(Context context, String packageName) {
        ...
        int targetHz = com.gamebooster.app.feature.performance.device.DevicePerformanceCapabilities.detect(context)
                .resolveRefreshRate(GameProfileAutoConfigurator.getTargetFpsHz(context));
