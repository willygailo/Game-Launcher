package com.gamebooster.app.platform.tile;
        ...
        if (isBoostActive) {
            ...
            AppExecutors.getInstance().executeCommand(() -> {
                MaxHzForceChannel.forceApply(getApplicationContext(),
                        com.gamebooster.app.feature.performance.display.DisplayOverrideController.highestSupportedRate(getApplicationContext()), null);
            ...
            AppExecutors.getInstance().executeCommand(() -> {
                com.gamebooster.app.feature.performance.display.DisplayOverrideController.restore(getApplicationContext());
